    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
            <Text style={styles.text_header}>Création de compte</Text>
            <Text style={styles.text_sous_title_header}>Devenir à présent membre en créant votre compte au système santé mentale Keshero!</Text>
        </View>
        <Animatable.View 
        ...
        >
            ...
            <Text style={styles.text_footer}>Adresse mail </Text>
            <View style={styles.action}>
                <FontAwesome 
                    name="envelope-o"
                    color="#05375a"
